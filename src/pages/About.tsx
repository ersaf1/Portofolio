              ...
              <div className="flex flex-wrap gap-2">
                {skillGroup.items.map((skill, i) => (
                  <motion.span
                    ...
                    className="px-3 py-1 bg-white/10 border border-white/10 rounded-lg text-sm cursor-default"
                  >
                    {skill}
                  </motion.span>
                ))}
      ...
      >
        ...
        <div className="space-y-6">
          {timeline.map((item, idx) => (
            ...
            >
              <div className="p-3 bg-gradient-to-r from-gray-600 to-gray-500 text-white rounded-xl">
                {item.icon}
              </div>
              <div>
