  ...
  return (
    <ScrollReveal delay={delay}>
      <a
        ...
        className={`card-comic ${s.accent} flex items-center gap-4 p-4 group bg-comic-white`}>
        ...
        <div className="space-y-4">
          ...
          <ScrollReveal delay={50}>
            <a href="mailto:ersafrexx@gmail.com"
              className="card-comic card-comic-red p-5 flex items-center gap-4 group bg-comic-white">
          ...
          <ScrollReveal delay={75}>
            <a href="tel:+6282227166906"
              className="card-comic card-comic-yellow p-5 flex items-center gap-4 group bg-comic-white">
          ...
          <ScrollReveal delay={100}>
            <div className="card-comic card-comic-yellow p-5">
          ...
          <ScrollReveal delay={150}>
            <div className="card-comic card-comic-black p-5">
